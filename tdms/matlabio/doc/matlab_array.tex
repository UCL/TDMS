...
will restrict it to arrays of two and three dimensions. Matlab
constructs its arrays by laying them out row-wise in memory. This is
depicted below in Figure
\begin{figure}[h]
  \includegraphics[width=1.\textwidth]{figures/array.eps}
  \caption{\label{fig:matlab:array} Layout of a matlab array in memory}
\end{figure}
