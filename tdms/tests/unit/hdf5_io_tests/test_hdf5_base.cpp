...
TEST_CASE("HDF5Base: has_MATLAB_empty()") {
  ...
  SECTION("Point to empty objects") {
    spdlog::info("HDF5Base::has_MATLAB_empty() [Empty objects]");
  ...
  SECTION("Point to non-empty objects") {
    spdlog::info("HDF5Base::has_MATLAB_empty() [Non-empty objects]");
  ...
  SECTION("Exception cases") {
    spdlog::info("HDF5Base::has_MATLAB_empty() [Exceptions]");
  ...
  SECTION("False positives") {
    spdlog::info("HDF5Base::has_MATLAB_empty() [False positives]");
