...
function [E] = efield_gauss(X,Y,Z)
    ...
    [EpN,Em] = focstratfield_general_pol([0 0 0],nvec,hvec,NA,lambda,ntheta,nphi,@gauss_pol);
    
    %calculate the field at the interface
    [Ep,Em] = focstratfield_general_pol(vertices,nvec,hvec,NA,lambda,ntheta,nphi,@gauss_pol);
