...
[x,y,z,~] = fdtd_bounds('pstd_input_file.m');
...
iteratefdtd_matrix('pstd_input_file.m','filesetup','in/pstd_sph_cubic','gridfile_sph.mat','illfile');
iteratefdtd_matrix('pstd_input_file.m','filesetup','in/pstd_fs_cubic','gridfile_fs.mat','illfile');
...
set_interpolation_method('in/pstd_sph_cubic', 'in/pstd_sph_bli', 2);
