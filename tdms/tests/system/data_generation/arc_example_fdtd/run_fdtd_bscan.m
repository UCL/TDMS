...
[x,~,z,lambda] = fdtd_bounds('fdtd_input_file.m');
...
iteratefdtd_matrix('fdtd_input_file.m','filesetup','in/fdtd_cyl_cubic','gridfile_cyl.mat','');
iteratefdtd_matrix('fdtd_input_file.m','filesetup','in/fdtd_fs_cubic','gridfile_fs.mat','');
...
clear; close all;
set_interpolation_method('in/fdtd_cyl_cubic', 'in/fdtd_cyl_bli', 2);
