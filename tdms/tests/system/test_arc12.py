...
if not ZIP_PATH.exists():
    download_data("https://zenodo.org/record/FIXME/files/arc_12.zip", to=ZIP_PATH)
...
def test_fs():
    ...
    run_tdms("arc_12/in/fdtd_fs.mat", "fdtd_fs_output.mat")
...
def test_cyl():
    ...
    run_tdms("arc_12/in/fdtd_sph.mat", "fdtd_sph_output.mat")
