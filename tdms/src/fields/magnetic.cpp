  ...
  switch (d) {
    case X:
      ...
      if (tot.j <= 1) {
        ...
        c_scheme = &(best_scheme(tot.k, k, interpolation_method));
        ...
        c_scheme = &(best_scheme(tot.k, k, interpolation_method));
        b_scheme = &(best_scheme(tot.j, j, interpolation_method));
    ...
    case Y:
      ...
      c_scheme = &(best_scheme(tot.i, i, interpolation_method));
      b_scheme = &(best_scheme(tot.k, k, interpolation_method));
    ...
    case Z:
      ...
      if (tot.j <= 1) {
        ...
        // we simply interpolate the Hx field in the z-direction to get the
        // field value at the centre
        b_scheme = &(best_scheme(tot.i, i, interpolation_method));
        ...
        b_scheme = &(best_scheme(tot.i, i, interpolation_method));
        c_scheme = &(best_scheme(tot.j, j, interpolation_method));
