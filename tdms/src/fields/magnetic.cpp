...
void MagneticField::interpolate_TE_components(CellCoordinate cell, complex<double> *x_at_centre,
...
void MagneticField::interpolate_TM_components(CellCoordinate cell, complex<double> *x_at_centre,
                                              complex<double> *y_at_centre,
                                              complex<double> *z_at_centre) {
