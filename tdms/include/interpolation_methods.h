...
enum scheme_value {
  ...
  BAND_LIMITED_3 =
          9,// use bandlimited interpolation w/ interp position = 3 [Preferred method if available]
  ...
  BAND_LIMITED_CELL_ZERO =
          1,// use bandlimited interpolation to interpolate to the centre of Yee cell 0
