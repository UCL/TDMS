...
void extractPhasorsVertices(double **EHr, double **EHi, const MagneticSplitField &H, const ElectricSplitField &E, ComplexAmplitudeSample &campssample, int n, double omega, double dt, int Nt,
