...
//fprintf(stderr,"Got   Ksource\n");
  ...
  */
  ...
  if( exphasorssurface && runmode==rm_complete){
    ...
    //castMatlab3DArray(double *array, int nrows, int ncols, int nlayers){
    /*&&*/
  ...
  */
  ...
  for(tind = start_tind; tind < *Nt; tind++){
    ...
    if((sourcemode==sm_steadystate)&&(runmode==rm_complete) && exphasorsvolume){
      ...
      if( exphasorssurface ){
	for(int i=0;i<N_f_ex_vec;i++)
	  extractPhasorsSurface( surface_EHr[i], surface_EHi[i],  
				 Hxy, Hxz, Hyx, Hyz, Hzx, Hzy,
				 Exy, Exz, Eyx, Eyz, Ezx, Ezy,
				 surface_vertices, n_surface_vertices, dft_counter, f_ex_vec[i]*2*dcpi, *dt, Nsteps, dimension,J_tot );
	dft_counter++;
      }
	...
	extractPhasorsSurface( surface_EHr[i], surface_EHi[i],  
			     ...
			     f_ex_vec[i]*2*dcpi, *dt, *Nt, dimension,J_tot );
...
//fprintf(stderr,"Pos 09:\n");
	...
	j=0;
	for(i=0;i<(I_tot+1);i++){
	  Eyz[(int)K0[0]][j][i] = Eyz[(int)K0[0]][j][i] - Cbz[(int)K0[0]]*real((KsourceR[0][i-((int)I0[0])][2] + I*KsourceI[0][i-((int)I0[0])][2])*(-1.0*I)*exp(-I*fmod(omega_an[0]*(time_H - to_l[0]),2.*dcpi)))*exp( -1.0*dcpi*pow((time_H - to_l[0] - dz/light_v)/(hwhm[0]),2));
	  ...
	  if(is_cond)
	    Jcyz[(int)K0[0]][j][i] += rho_z[(int)K0[0]]*Cbz[(int)K0[0]]*real((KsourceR[0][i-((int)I0[0])][2] + I*KsourceI[0][i-((int)I0[0])][2])*(-1.0*I)*exp(-I*fmod(omega_an[0]*(time_H - to_l[0]),2.*dcpi)))*exp( -1.0*dcpi*pow((time_H - to_l[0] - dz/light_v)/(hwhm[0]),2));
	  ...
	  if(is_disp_ml){
	    Jyz[(int)K0[0]][j][i] -= ml_kappa_z[(int)K0[0]]*ml_gamma[(int)K0[0]]/(2.*dt[0])*Cbz[(int)K0[0]]*real((KsourceR[0][i-((int)I0[0])][2] + I*KsourceI[0][i-((int)I0[0])][2])*(-1.0*I)*exp(-I*fmod(omega_an[0]*(time_H - to_l[0]),2.*dcpi)))*exp( -1.0*dcpi*pow((time_H - to_l[0] - dz/light_v)/(hwhm[0]),2));
	  ...
	  for(j=0;j<J_tot;j++)
	    for(i=0;i<(I_tot+1);i++){
	      Eyz[(int)K0[0]][j][i] = Eyz[(int)K0[0]][j][i] - Cbz[(int)K0[0]]*real((KsourceR[j-((int)J0[0])][i-((int)I0[0])][2] + I*KsourceI[j-((int)J0[0])][i-((int)I0[0])][2])*(-1.0*I)*exp(-I*fmod(omega_an[0]*(time_H - to_l[0]),2.*dcpi)))*exp( -1.0*dcpi*pow((time_H - to_l[0] - dz/light_v)/(hwhm[0]),2));
	    ...
	    if(is_cond)
	      Jcyz[(int)K0[0]][j][i] += rho_z[(int)K0[0]]*Cbz[(int)K0[0]]*real((KsourceR[j-((int)J0[0])][i-((int)I0[0])][2] + I*KsourceI[j-((int)J0[0])][i-((int)I0[0])][2])*(-1.0*I)*exp(-I*fmod(omega_an[0]*(time_H - to_l[0]),2.*dcpi)))*exp( -1.0*dcpi*pow((time_H - to_l[0] - dz/light_v)/(hwhm[0]),2));
	    ...
	    if(is_disp_ml){
	      Jyz[(int)K0[0]][j][i] -= ml_kappa_z[(int)K0[0]]*ml_gamma[(int)K0[0]]/(2.*dt[0])*Cbz[(int)K0[0]]*real((KsourceR[j-((int)J0[0])][i-((int)I0[0])][2] + I*KsourceI[j-((int)J0[0])][i-((int)I0[0])][2])*(-1.0*I)*exp(-I*fmod(omega_an[0]*(time_H - to_l[0]),2.*dcpi)))*exp( -1.0*dcpi*pow((time_H - to_l[0] - dz/light_v)/(hwhm[0]),2));
      ...
      for(j=0;j<(J_tot+1);j++)
	for(i=0;i<I_tot;i++){
	  Exz[(int)K0[0]][j][i] = Exz[(int)K0[0]][j][i] + Cbz[(int)K0[0]]*real((KsourceR[j-((int)J0[0])][i-((int)I0[0])][3] + I*KsourceI[j-((int)J0[0])][i-((int)I0[0])][3])*(-1.0*I)*exp(-I*fmod(omega_an[0]*(time_H - to_l[0]),2*dcpi)))*exp( -1.0*dcpi*pow((time_H - to_l[0] - dz/light_v)/(hwhm[0]),2 ));
	  ...
	  if(is_cond)
	    Jcxz[(int)K0[0]][j][i] -= rho_z[(int)K0[0]]*Cbz[(int)K0[0]]*real((KsourceR[j-((int)J0[0])][i-((int)I0[0])][3] + I*KsourceI[j-((int)J0[0])][i-((int)I0[0])][3])*(-1.0*I)*exp(-I*fmod(omega_an[0]*(time_H - to_l[0]),2*dcpi)))*exp( -1.0*dcpi*pow((time_H - to_l[0] - dz/light_v)/(hwhm[0]),2 ));
	  ...
	  if(is_disp_ml)
	    Jxz[(int)K0[0]][j][i] += ml_kappa_z[(int)K0[0]]*ml_gamma[(int)K0[0]]/(2.*dt[0])*Cbz[(int)K0[0]]*real((KsourceR[j-((int)J0[0])][i-((int)I0[0])][3] + I*KsourceI[j-((int)J0[0])][i-((int)I0[0])][3])*(-1.0*I)*exp(-I*fmod(omega_an[0]*(time_H - to_l[0]),2*dcpi)))*exp( -1.0*dcpi*pow((time_H - to_l[0] - dz/light_v)/(hwhm[0]),2 ));
      ...
      fth = real((-1.0*I)*exp(-I*fmod(omega_an[0]*(time_H - to_l[0]),2.*dcpi)))*exp( -1.0*dcpi*pow((time_H - to_l[0] - dz/light_v)/(hwhm[0]),2));
...
//fprintf(stderr,"Pos 11:\n");
 ...
 //fprintf(stderr,"Pos 11:\n");
	...
	for(int i=0;i<N_f_ex_vec;i++){
	  extractPhasorENorm(&E_norm[i], fte, tind, f_ex_vec[i]*2*dcpi, *dt, Nsteps);
	  extractPhasorHNorm(&H_norm[i], fth, tind, f_ex_vec[i]*2*dcpi, *dt, Nsteps);
	}
      }
      else{
	extractPhasorENorm(&E_norm_an, fte, tind, *omega_an, *dt, *Nt);
	extractPhasorHNorm(&H_norm_an, fth, tind, *omega_an, *dt, *Nt);
	for(int i=0;i<N_f_ex_vec;i++){
	  extractPhasorENorm(&E_norm[i], fte, tind, f_ex_vec[i]*2*dcpi, *dt, *Nt);
	  extractPhasorHNorm(&H_norm[i], fth, tind, f_ex_vec[i]*2*dcpi, *dt, *Nt);
	}
      }
  ...
  if(runmode == rm_complete && exphasorssurface)
    for(int i=0;i<N_f_ex_vec;i++)
      normaliseSurface( &surface_EHr[i], &surface_EHi[i],  
			surface_vertices, n_surface_vertices, E_norm[i], H_norm[i]);
...
void extractPhasorsSurface( double **surface_EHr, double **surface_EHi,  
  ...
  complex<double> phaseTermE, phaseTermH, subResultE, subResultH;
  ...
  for(vindex = 0; vindex<n_surface_vertices; vindex++){
    ...
    /*Ex and Hx*/
    subResultH = Hx * exp(phaseTermH * I) * 1./((double) Nt);
    subResultE = Ex * exp(phaseTermE * I) * 1./((double) Nt);
    ...
    /*Ey and Hy*/
    subResultH = Hy * exp(phaseTermH * I) * 1./((double) Nt);
    subResultE = Ey * exp(phaseTermE * I) * 1./((double) Nt);
    ...
    /*Ez and Hz*/
    subResultH = Hz * exp(phaseTermH * I) * 1./((double) Nt);
    subResultE = Ez * exp(phaseTermE * I) * 1./((double) Nt);
