...
function [fdtdgrid, Ex_out, Ey_out, Ez_out, Hx_out, Hy_out, Hz_out, Ex_bs, Ey_bs, Hx_bs, Hy_bs, x_out, y_out, z_out, Ex_i, Ey_i, Ez_i, Hx_i, Hy_i, Hz_i,x_i,y_i,z_i,vertices,camplitudes,facets,maxresfield] = iteratefdtd_matrix_debug(input_file,operation,outfile,material_file,ill_file)
...
%and y in the detector space which may be done as
	...
	save detvars_c Dx Dx_tilde fx_vec fy_vec  i_obs j_obs x y k_det_obs illorigin Dzl delta;
    else
	Pupil = [];
